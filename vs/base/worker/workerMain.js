 ...
 *-----------------------------------------------------------*/
(function() {
    var e = ["exports", "require", "vs/editor/common/core/position", "vs/base/common/winjs.base", "vs/base/common/errors", "vs/base/common/platform", "vs/base/common/uri", "vs/editor/common/core/range", "vs/editor/common/core/uint", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/cancellation", "vs/base/common/functional", "vs/base/common/diff/diff", "vs/base/common/async", "vs/base/common/map", "vs/base/common/strings", "vs/editor/common/model/mirrorTextModel", "vs/base/common/linkedList", "vs/base/common/keyCodes", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/base/common/diff/diffChange", "vs/editor/common/core/characterClassifier", "vs/editor/common/diff/diffComputer", "vs/editor/common/model/wordHelper", "vs/editor/common/modes/linkComputer", "vs/editor/common/modes/supports/inplaceReplaceSupport", "vs/editor/common/standalone/standaloneBase", "vs/editor/common/viewModel/prefixSumComputer", "vs/base/common/worker/simpleWorker", "vs/editor/common/services/editorSimpleWorker"],
        t = function(t) {
    ...
    ! function(e) {
        ...
        var n = function() {
            function n(e, n) {
                if (this._env = e, this.options = t.mergeConfigurationOptions(n), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
            ...
            return n.prototype._createIgnoreDuplicateModulesMap = function() {
                ...
                n.prototype.getOptionsLiteral = function() {
                    ...
                    var n, r = t;
                    if (e.Utilities.endsWith(r, ".js") || e.Utilities.isAbsolutePath(r)) e.Utilities.endsWith(r, ".js") || e.Utilities.containsQueryString(r) || (r += ".js"),
                        n = [r];
                    else
    ...
    ! function(e) {
        var t = function() {
                ...
                return e.prototype.load = function(e, t, o, s) {
                    var u = this;
                    this._scriptLoader || (this._scriptLoader = this._env.isWebWorker ? new r : this._env.isNode ? new i(this._env) : new n);
                    var a = {
                        callback: o,
                        errorback: s
                    };
            ...
            i = function() {
                ...
                return t.prototype._init = function(e) {
                    ...
                    if (/^node\|/.test(r)) {
                        ...
                        if (e) o(e);
                            ...
                            if (s._env.isElectronRenderer) {
                                var d = h.match(/^([a-z])\:(.*)/i);
                                h = d ? "file:///" + (d[1].toUpperCase() + ":" + d[2]).replace(/\\/g, "/") : "file://" + h
                            }
                            var p, m = "(function (require, define, __filename, __dirname) { ";
                            if (p = a.charCodeAt(0) === t._BOM ? m + a.substring(1) + "\n});" : m + a + "\n});", p = l(p, f), u.nodeCachedDataDir) {
                            ...
                            } else s._loadAndEvalScript(n, r, h, p, {
                                filename: h
                            }, c), i()
                        }
                    })
                    ...
                    return u.runInThisContext(o).call(e.global, t.getGlobalAMDRequireFunc(), t.getGlobalAMDDefineFunc(), r, this._path.dirname(n)), s.record(32, n), u
    ...
    ! function(e) {
        ...
        var s = function() {
            function s(t, n, i, o, s) {
                void 0 === s && (s = 0), this._env = t, this._scriptLoader = n,
                        ...
                        var i = -1,
                            o = function(n) {
                                if (++i >= r.length) t._onLoadError(e, n);
                                    ...
                                    u.record(10, s), t._scriptLoader.load(t, s, function() {
    ...
    ! function(e) {
        function t() {
            if (void 0 !== e.global.require || "undefined" != typeof require) {
                ...
                if ("function" == typeof t && "function" == typeof t.resolve) {
                    ...
                    e.global.nodeRequire = r, u.nodeRequire = r, u.__$__nodeRequire = r
                }
            }
            n.isNode && !n.isElectronRenderer ? (module.exports = u, require = u) : (n.isElectronRenderer || (e.global.define = o), e.global.require = u)
        }
        var n = new e.Environment,
            i = null,
            o = function(e, t, n) {
                "string" != typeof e && (n = t, t = e, e = null), "object" == typeof t && Array.isArray(t) || (n = t, t = null), t || (t = ["require", "exports", "module"]), e ? i.defineModule(e, t, n, null, null) : i.enqueueDefineAnonymousModule(t, n)
            };
        o.amd = {
            jQuery: !0
        };
        ...
        u.config = s, u.getConfig = function() {
        ...
        }, e.init = t, "function" == typeof e.global.define && e.global.define.amd || (i = new e.ModuleManager(n, e.createScriptLoader(n), o, u, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && u.config(e.global.require), (r = function() {
                return o.apply(null, arguments)
            }).amd = o.amd,
            "undefined" == typeof doNotInitLoader && t())
    }(i || (i = {})), r(e[22], t([1, 0]), function(e, t) {
        "use strict";
        ...
        var s = function() {
                function e() {
                    this.m_changes = [],
                        this.m_originalStart = Number.MAX_VALUE, this.m_modifiedStart = Number.MAX_VALUE, this.m_originalCount = 0, this.m_modifiedCount = 0
                }
            ...
            a = function() {
                ...
                return e.prototype.ComputeUniqueIdentifiers = function() {
                        ...
                        for (n = 0; n < e; n++) {
                            ...
                            u.call(r, o) ? this.m_originalIds[n] = r[o] : (this.m_originalIds[n] = i++, r[o] = this.m_originalIds[n])
                        }
                        for (n = 0; n < t; n++) {
                            var s = this.ModifiedSequence.getElementHash(n);
                            u.call(r, s) ? this.m_modifiedIds[n] = r[s] : (this.m_modifiedIds[n] = i++, r[s] = this.m_modifiedIds[n])
                        }
                        ...
                        if (e > t || r > o) {
                            var u = void 0;
                            return r <= o ? (i.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), u = [new n.DiffChange(e, 0, r, o - r + 1)]) : e <= t ? (i.Assert(r === o + 1, "modifiedStart should only be one more than modifiedEnd"),
                                u = [new n.DiffChange(e, t - e + 1, r, 0)]) : (i.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), i.Assert(r === o + 1, "modifiedStart should only be one more than modifiedEnd"), u = []), u
                        }
                        var a = [0],
                            l = [0],
                        ...
                        if (!s[0]) {
                            var d = this.ComputeDiffRecursive(e, f, r, h, s),
                                p = [];
                            return p = s[0] ? [new n.DiffChange(f + 1, t - (f + 1) + 1, h + 1, o - (h + 1) + 1)] : this.ComputeDiffRecursive(f + 1, t, h + 1, o, s), this.ConcatenateChanges(d, p)
                        }
                        ...
                        do {
                            (b = N + e) === L || b < A && c[b - 1] < c[b + 1] ? (m = (h = c[b + 1]) - N - i, h < P && S.MarkNextChange(), P = h, S.AddModifiedElement(h + 1, m), N = b + 1 - e) : (m = (h = c[b - 1] + 1) - N - i, h < P && S.MarkNextChange(), P = h - 1, S.AddOriginalElement(h, m + 1), N = b - 1 - e), M >= 0 && (e = (c = this.m_forwardHistory[M])[0], L = 1, A = c.length - 1)
                        } while (--M >= -1);
                        if (C = S.getReverseChanges(), y[0]) {
                            ...
                            S = new s, L = u, A = a, N = p[0] - g[0] - l, P = Number.MAX_VALUE, M = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                            do {
                                (b = N + o) === L || b < A && f[b - 1] >= f[b + 1] ? (m = (h = f[b + 1] - 1) - N - l, h > P && S.MarkNextChange(), P = h + 1, S.AddOriginalElement(h + 1, m + 1), N = b + 1 - o) : (m = (h = f[b - 1]) - N - l, h > P && S.MarkNextChange(), P = h, S.AddModifiedElement(h + 1, m + 1), N = b - 1 - o), M >= 0 && (o = (f = this.m_reverseHistory[M])[0], L = 1, A = f.length - 1)
                            } while (--M >= -1);
                            E = S.getChanges()
                        }
                        ...
                        for (f = 1; f <= _ / 2 + 1; f++) {
                            var P = 0,
                                M = 0;
                            for (h = this.ClipDiagonalBound(b - f, f, b, g), d = this.ClipDiagonalBound(b + f, f, b, g),
                                A = h; A <= d; A += 2) {
                                for (c = (l = A === h || A < d && v[A - 1] < v[A + 1] ? v[A + 1] : v[A - 1] + 1) - (A - b) - E, N = l; l < t && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
                                if (v[A] = l, l + c > P + M && (P = l, M = c), !L && Math.abs(A - C) <= f - 1 && l >= y[A]) return s[0] = l, u[0] = c, N <= y[A] && f <= 1448 ? this.WALKTRACE(b, h, d, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : null
                            }
                            var w = (P - e + (M - r) - f) / 2;
                            if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(P, this.OriginalSequence, w)) return a[0] = !0, s[0] = P, u[0] = M, w > 0 && f <= 1448 ? this.WALKTRACE(b, h, d, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)]);
                            for (p = this.ClipDiagonalBound(C - f, f, C, g), m = this.ClipDiagonalBound(C + f, f, C, g), A = p; A <= m; A += 2) {
                                for (c = (l = A === p || A < m && y[A - 1] >= y[A + 1] ? y[A + 1] - 1 : y[A - 1]) - (A - C) - S, N = l; l > e && c > r && this.ElementsAreEqual(l, c);) l--, c--;
                                if (y[A] = l, L && Math.abs(A - b) <= f && l <= v[A]) return s[0] = l, u[0] = c, N >= v[A] && f <= 1448 ? this.WALKTRACE(b, h, d, E, C, p, m, S, v, y, l, t, s, c, i, u, L, a) : null
                            }
                            if (f <= 1447) {
                                var D = new Array(d - h + 2);
                                D[0] = b - h + 1, o.Copy(v, h, D, 1, d - h + 1), this.m_forwardHistory.push(D), (D = new Array(m - p + 2))[0] = C - p + 1,
                                    o.Copy(y, p, D, 1, m - p + 1), this.m_reverseHistory.push(D)
                            }
                        }
                        ...
                        do {
                            ...
                            for (l = 0; l < e.length; l++)
                                for (var n = e[l], r = l < e.length - 1 ? e[l + 1].originalStart : this.OriginalSequence.getLength(), i = l < e.length - 1 ? e[l + 1].modifiedStart : this.ModifiedSequence.getLength(), o = n.originalLength > 0, s = n.modifiedLength > 0; n.originalStart + n.originalLength < r && n.modifiedStart + n.modifiedLength < i && (!o || this.OriginalElementsAreEqual(n.originalStart, n.originalStart + n.originalLength)) && (!s || this.ModifiedElementsAreEqual(n.modifiedStart, n.modifiedStart + n.modifiedLength));) n.originalStart++, n.modifiedStart++;
                            for (var u = new Array, a = [null], l = 0; l < e.length; l++) l < e.length - 1 && this.ChangesOverlap(e[l], e[l + 1], a) ? (t = !0, u.push(a[0]), l++) : u.push(e[l]);
                            e = u
                        } while (t);
                        for (l = e.length - 1; l >= 0; l--) {
                            ...
                            if (l > 0) {
                                var c = e[l - 1];
                                c.originalLength > 0 && (r = c.originalStart + c.originalLength), c.modifiedLength > 0 && (i = c.modifiedStart + c.modifiedLength)
                            }
                            for (var o = n.originalLength > 0, s = n.modifiedLength > 0, f = 0, h = this._boundaryScore(n.originalStart, n.originalLength, n.modifiedStart, n.modifiedLength), d = 1;; d++) {
                        ...
                        return e <= 0 || e >= this.OriginalSequence.getLength() - 1 || /^\s*$/.test(this.OriginalSequence.getElementHash(e))
                        ...
                        return e <= 0 || e >= this.ModifiedSequence.getLength() - 1 || /^\s*$/.test(this.ModifiedSequence.getElementHash(e))
                    },
                    e.prototype._ModifiedRegionIsBoundary = function(e, t) {
                        ...
                        var n = [],
                            r = null;
                        return 0 === e.length || 0 === t.length ? t.length > 0 ? t : e : this.ChangesOverlap(e[e.length - 1], t[0], n) ? (r = new Array(e.length + t.length - 1), o.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], o.Copy(t, 1, r, e.length, t.length - 1), r) : (r = new Array(e.length + t.length), o.Copy(e, 0, r, 0, e.length), o.Copy(t, 0, r, e.length, t.length), r)
                    }, e.prototype.ChangesOverlap = function(e, t, r) {
                        if (i.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), i.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"),
                            e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
                            var o = e.originalStart,
                                s = e.originalLength,
                                u = e.modifiedStart,
                                a = e.modifiedLength;
                            return e.originalStart + e.originalLength >= t.originalStart && (s = t.originalStart + t.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= t.modifiedStart && (a = t.modifiedStart + t.modifiedLength - e.modifiedStart), r[0] = new n.DiffChange(o, s, u, a), !0
                        }
                        return r[0] = null, !1
        ...
        ! function(e) {
            e[e.Unknown = 0] = "Unknown", e[e.Backspace = 1] = "Backspace", e[e.Tab = 2] = "Tab", e[e.Enter = 3] = "Enter", e[e.Shift = 4] = "Shift", e[e.Ctrl = 5] = "Ctrl", e[e.Alt = 6] = "Alt", e[e.PauseBreak = 7] = "PauseBreak", e[e.CapsLock = 8] = "CapsLock", e[e.Escape = 9] = "Escape", e[e.Space = 10] = "Space", e[e.PageUp = 11] = "PageUp", e[e.PageDown = 12] = "PageDown", e[e.End = 13] = "End", e[e.Home = 14] = "Home", e[e.LeftArrow = 15] = "LeftArrow", e[e.UpArrow = 16] = "UpArrow", e[e.RightArrow = 17] = "RightArrow", e[e.DownArrow = 18] = "DownArrow", e[e.Insert = 19] = "Insert", e[e.Delete = 20] = "Delete", e[e.KEY_0 = 21] = "KEY_0", e[e.KEY_1 = 22] = "KEY_1", e[e.KEY_2 = 23] = "KEY_2", e[e.KEY_3 = 24] = "KEY_3", e[e.KEY_4 = 25] = "KEY_4", e[e.KEY_5 = 26] = "KEY_5", e[e.KEY_6 = 27] = "KEY_6", e[e.KEY_7 = 28] = "KEY_7", e[e.KEY_8 = 29] = "KEY_8", e[e.KEY_9 = 30] = "KEY_9", e[e.KEY_A = 31] = "KEY_A", e[e.KEY_B = 32] = "KEY_B", e[e.KEY_C = 33] = "KEY_C", e[e.KEY_D = 34] = "KEY_D", e[e.KEY_E = 35] = "KEY_E", e[e.KEY_F = 36] = "KEY_F", e[e.KEY_G = 37] = "KEY_G", e[e.KEY_H = 38] = "KEY_H", e[e.KEY_I = 39] = "KEY_I", e[e.KEY_J = 40] = "KEY_J", e[e.KEY_K = 41] = "KEY_K", e[e.KEY_L = 42] = "KEY_L",
                e[e.KEY_M = 43] = "KEY_M", e[e.KEY_N = 44] = "KEY_N", e[e.KEY_O = 45] = "KEY_O", e[e.KEY_P = 46] = "KEY_P", e[e.KEY_Q = 47] = "KEY_Q", e[e.KEY_R = 48] = "KEY_R", e[e.KEY_S = 49] = "KEY_S", e[e.KEY_T = 50] = "KEY_T", e[e.KEY_U = 51] = "KEY_U", e[e.KEY_V = 52] = "KEY_V", e[e.KEY_W = 53] = "KEY_W", e[e.KEY_X = 54] = "KEY_X", e[e.KEY_Y = 55] = "KEY_Y", e[e.KEY_Z = 56] = "KEY_Z", e[e.Meta = 57] = "Meta", e[e.ContextMenu = 58] = "ContextMenu", e[e.F1 = 59] = "F1", e[e.F2 = 60] = "F2", e[e.F3 = 61] = "F3", e[e.F4 = 62] = "F4", e[e.F5 = 63] = "F5", e[e.F6 = 64] = "F6", e[e.F7 = 65] = "F7", e[e.F8 = 66] = "F8", e[e.F9 = 67] = "F9", e[e.F10 = 68] = "F10", e[e.F11 = 69] = "F11", e[e.F12 = 70] = "F12", e[e.F13 = 71] = "F13", e[e.F14 = 72] = "F14", e[e.F15 = 73] = "F15", e[e.F16 = 74] = "F16", e[e.F17 = 75] = "F17", e[e.F18 = 76] = "F18", e[e.F19 = 77] = "F19", e[e.NumLock = 78] = "NumLock", e[e.ScrollLock = 79] = "ScrollLock", e[e.US_SEMICOLON = 80] = "US_SEMICOLON", e[e.US_EQUAL = 81] = "US_EQUAL", e[e.US_COMMA = 82] = "US_COMMA", e[e.US_MINUS = 83] = "US_MINUS", e[e.US_DOT = 84] = "US_DOT", e[e.US_SLASH = 85] = "US_SLASH", e[e.US_BACKTICK = 86] = "US_BACKTICK", e[e.US_OPEN_SQUARE_BRACKET = 87] = "US_OPEN_SQUARE_BRACKET",
                e[e.US_BACKSLASH = 88] = "US_BACKSLASH", e[e.US_CLOSE_SQUARE_BRACKET = 89] = "US_CLOSE_SQUARE_BRACKET", e[e.US_QUOTE = 90] = "US_QUOTE", e[e.OEM_8 = 91] = "OEM_8", e[e.OEM_102 = 92] = "OEM_102", e[e.NUMPAD_0 = 93] = "NUMPAD_0", e[e.NUMPAD_1 = 94] = "NUMPAD_1", e[e.NUMPAD_2 = 95] = "NUMPAD_2", e[e.NUMPAD_3 = 96] = "NUMPAD_3", e[e.NUMPAD_4 = 97] = "NUMPAD_4", e[e.NUMPAD_5 = 98] = "NUMPAD_5", e[e.NUMPAD_6 = 99] = "NUMPAD_6", e[e.NUMPAD_7 = 100] = "NUMPAD_7", e[e.NUMPAD_8 = 101] = "NUMPAD_8", e[e.NUMPAD_9 = 102] = "NUMPAD_9", e[e.NUMPAD_MULTIPLY = 103] = "NUMPAD_MULTIPLY", e[e.NUMPAD_ADD = 104] = "NUMPAD_ADD", e[e.NUMPAD_SEPARATOR = 105] = "NUMPAD_SEPARATOR", e[e.NUMPAD_SUBTRACT = 106] = "NUMPAD_SUBTRACT", e[e.NUMPAD_DECIMAL = 107] = "NUMPAD_DECIMAL", e[e.NUMPAD_DIVIDE = 108] = "NUMPAD_DIVIDE", e[e.KEY_IN_COMPOSITION = 109] = "KEY_IN_COMPOSITION", e[e.ABNT_C1 = 110] = "ABNT_C1", e[e.ABNT_C2 = 111] = "ABNT_C2", e[e.MAX_VALUE = 112] = "MAX_VALUE"
        }(t.KeyCode || (t.KeyCode = {}));
        var r = function() {
                function e() {
        ...
        }(t.KeyMod || (t.KeyMod = {})), t.KeyChord = function(e, t) {
        ...
        var a = function() {
            ...
            return e.prototype.equals = function(e) {
                ...
                return "" + (this.ctrlKey ? "1" : "0") + (this.shiftKey ? "1" : "0") + (this.altKey ? "1" : "0") + (this.metaKey ? "1" : "0") + this.keyCode
        ...
        var l = function() {
            ...
            return e.prototype.getHashCode = function() {
        ...
        var c = function() {
            return function(e, t, n, r, i, o) {
                this.ctrlKey = e, this.shiftKey = t, this.altKey = n, this.metaKey = r, this.keyLabel = i,
                    this.keyAriaLabel = o
            }
        }();
        ...
        var n = !1,
            ...
            a = void 0,
            l = void 0;
        if (t.LANGUAGE_DEFAULT = "en", "object" == typeof process && "function" == typeof process.nextTick && "string" == typeof process.platform) {
            n = "win32" === process.platform,
                r = "darwin" === process.platform, i = "linux" === process.platform;
            var c = process.env.VSCODE_NLS_CONFIG;
            if (c) try {
                var f = JSON.parse(c),
                    h = f.availableLanguages["*"];
                u = f.locale, a = h || t.LANGUAGE_DEFAULT, l = f._translationsConfigFile
            } catch (e) {}
            o = !0
        } else if ("object" == typeof navigator) {
            var d = navigator.userAgent;
            n = d.indexOf("Windows") >= 0, r = d.indexOf("Macintosh") >= 0, i = d.indexOf("Linux") >= 0, s = !0, a = u = navigator.language
        }
        var p;
        ! function(e) {
        ...
        var m = p.Web;
        o && (r ? m = p.Mac : n ? m = p.Windows : i && (m = p.Linux)), t.isWindows = n, t.isMacintosh = r, t.isLinux = i, t.isNative = o, t.isWeb = s, t.platform = m, t.isRootUser = function() {
            return o && !n && 0 === process.getuid()
        }, t.language = a, t.locale = u, t.translationsConfigFile = l;
        var _ = "object" == typeof self ? self : "object" == typeof global ? global : {};
        t.globals = _;
        var g = null;
        t.setImmediate = function(e) {
            return null === g && (g = t.globals.setImmediate ? t.globals.setImmediate.bind(t.globals) : "undefined" != typeof process && "function" == typeof process.nextTick ? process.nextTick.bind(process) : t.globals.setTimeout.bind(t.globals)), g(e)
        };
        ! function(e) {
    ...
    r(e[6], t([1, 0, 5]), function(e, t, n) {
        ...
        function i(e) {
            var t;
            return t = e.authority && e.path && "file" === e.scheme ? "//" + e.authority + e.path : d.test(e.path) ? e.path[1].toLowerCase() + e.path.substr(2) : e.path, n.isWindows && (t = t.replace(/\//g, "\\")), t
        }
        ...
        function s(e, t) {
            ...
            if (o && i.push(o, ":"), (s || "file" === o) && i.push("//"), s) {
                if (-1 !== (_ = s.indexOf("@"))) {
                    var h = s.substr(0, _);
                    s = s.substr(_ + 1), -1 === (_ = h.indexOf(":")) ? i.push(n(h)) : i.push(n(h.substr(0, _)), ":", n(h.substr(_ + 1))), i.push("@")
                } - 1 === (_ = (s = s.toLowerCase()).indexOf(":")) ? i.push(n(s)) : i.push(n(s.substr(0, _)), s.substr(_))
            }
            if (u) {
                var d = p.exec(u);
        ...
        var u = /^\w[\w\d+.-]*$/,
            ...
            _ = function() {
                function e(e, t, n, r, i) {
                    "object" == typeof e ? (this.scheme = e.scheme || c, this.authority = e.authority || c, this.path = e.path || c, this.query = e.query || c, this.fragment = e.fragment || c) : (this.scheme = e || c, this.authority = t || c, this.path = n || c, this.query = r || c, this.fragment = i || c, function(e) {
                ...
                return e.isUri = function(t) {
                    ...
                    var t = e.scheme,
                        ...
                        i = e.query,
                        o = e.fragment;
                    return void 0 === t ? t = this.scheme : null === t && (t = c), void 0 === n ? n = this.authority : null === n && (n = c), void 0 === r ? r = this.path : null === r && (r = c), void 0 === i ? i = this.query : null === i && (i = c), void 0 === o ? o = this.fragment : null === o && (o = c), t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new g(t, n, r, i, o)
                }, e.parse = function(e) {
                    var t = h.exec(e);
                    return t ? new g(t[2] || c, decodeURIComponent(t[4] || c), decodeURIComponent(t[5] || c), decodeURIComponent(t[7] || c), decodeURIComponent(t[9] || c)) : new g(c, c, c, c, c)
                }, e.file = function(e) {
                    var t = c;
                    if (n.isWindows && (e = e.replace(/\\/g, f)), e[0] === f && e[1] === f) {
                        var r = e.indexOf(f, 2); - 1 === r ? (t = e.substring(2), e = f) : (t = e.substring(2, r), e = e.substring(r) || f)
                    }
                    return m.test(e) ? e = f + e : e[0] !== f && (e = f + e), new g("file", t, e, c, c)
                }, e.from = function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.values = r, t.keys = i, t.getOrSet = function(e, t, n) {
            var r = e.get(t);
        ...
        var d = function(e) {
            ...
            return o(t, e), Object.defineProperty(t.prototype, "limit", {
                get: function() {
                    return this._limit
                },
                set: function(e) {
        ...
        t.isBasicASCII = function(e) {
            ...
            return !1
        }, t.isFullWidthCharacter = d, t.lcut = function(e, n) {
        ...
        t.removeAnsiEscapeCodes = function(e) {
            return e && (e = (e = (e = e.replace(E, "")).replace(S, "")).replace(L, "")), e
        }, t.UTF8_BOM_CHARACTER = String.fromCharCode(65279), t.startsWithUTF8BOM = p, t.stripUTF8BOM = function(e) {
    ...
    ! function() {
        ...
        t("WinJS/Core/_Global", [], function() {
            ...
            return {
                ...
                _setImmediate: function(n) {
                    null === t && (t = e.setImmediate ? e.setImmediate.bind(e) : "undefined" != typeof process && "function" == typeof process.nextTick ? process.nextTick.bind(process) : e.setTimeout.bind(e)), t(n)
                }
            }
            ...
            function i(e, t, n) {
                ...
                for (i = 0, o = s.length; i < o; i++) {
                    ...
                    !c || "object" != typeof c || void 0 === c.value && "function" != typeof c.get && "function" != typeof c.set ? l ? u ? e.forEach(function(e) {
                        ...
                        configurable: !0,
                        writable: !0
                    } : (void 0 === c.enumerable && (c.enumerable = l), n && c.setName && "function" == typeof c.setName && c.setName(n + "." + a), (r = r || {})[a] = c)
                }
            ...
            function u(e, t) {
                var n;
                n = t && "object" == typeof t && "function" == typeof t.then ? I : T, e._value = t, e._setState(n)
            }
                ...
                if (i) {
                    ...
                    for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
                        var a = 1 === u ? i : i[s],
                            c = a.e,
                            f = a.promise,
                            h = e.Debug && (r && r.name === N ? e.Debug.MS_ASYNC_OP_STATUS_CANCELED : e.Debug.MS_ASYNC_OP_STATUS_ERROR);
                        if (o._traceAsyncOperationCompleted(a.asyncOpID, h), f) {
                            var d = !1;
                            try {
                                c ? (o._traceAsyncCallbackStarting(a.asyncOpID), d = !0, c.handlesOnError || g(f, r, l, t, c),
                                    f._setCompleteValue(c(r))) : f._setChainedErrorValue(r, t)
                            } catch (e) {
            ...
            function E(e, t) {
                var n;
                n = t && "object" == typeof t && "function" == typeof t.then ? I : U, e._value = t, e._setState(n)
            }
            ...
            var L = new(n.Class.mix(n.Class.define(null, {}, {
                supportedForProcessing: !1
            }), i.eventMixin));
            L._listeners = {};
            var A = "error",
            ...
            w = {
                ...
                enter: function(e) {
                    var t = e._value;
                    if (t instanceof Y && t._state !== F && t._state !== U) y(t, {
                        promise: e
                    });
                    else {
                        var n = function(r) {
            ...
            var W, q = n.Class.define(null, {
                ...
                Y = n.Class.derive(q, function(e) {
                    P && (!0 === P || P & M.thenPromise) && (this._stack = H._getStack()), this._creator = e, this._setState(w), this._run()
                }, {
                    _creator: null,
                ...
                j = n.Class.define(function(e) {
                    P && (!0 === P || P & M.errorPromise) && (this._stack = H._getStack()), this._value = e, g(this, e, f)
                }, {
                    cancel: function() {},
                    done: function(e, t) {
                        var n = this._value;
                    ...
                    then: function(e, t) {
                        ...
                        var n, r = this._value;
                        try {
                            t.handlesOnError || g(null, r, l, this, t), n = new V(t(r))
                        } catch (e) {
                            n = e === r ? this : new B(e)
                        }
                        return n
                ...
                B = n.Class.derive(j, function(e) {
                    P && (!0 === P || P & M.exceptionPromise) && (this._stack = H._getStack()), this._value = e, g(this, e, h)
                }, {}, {
                    supportedForProcessing: !1
                }),
                V = n.Class.define(function(e) {
                    if (P && (!0 === P || P & M.completePromise) && (this._stack = H._getStack()), e && "object" == typeof e && "function" == typeof e.then) {
                        var t = new Y(null);
                ...
                H = n.Class.derive(q, function(e, t) {
                    P && (!0 === P || P & M.promise) && (this._stack = H._getStack()), this._oncancel = t, this._setState(w), this._run();
                    try {
                        ...
                        return new H(function(t, n) {
                            ...
                            r.forEach(function(o) {
                                H.as(e[o]).then(function() {
                                    ...
                                    s instanceof Error && s.name === N ? ++i === r.length && t(H.cancel) : n({
                                        key: o,
                                        value: e[o]
                                    })
                                })
        ...
        }), (s = e["WinJS/Core/_WinJS"]).TPromise = s.Promise, s.PPromise = s.Promise, "undefined" == typeof exports && "function" == typeof r && r.amd ? r("vs/base/common/winjs.base", [], s) : module.exports = s
            ...
            n.TPromise.addEventListener("error", function(e) {
                var t = e.detail,
                    n = t.id;
                t.parent ? t.handler && o && delete o[n] : (o[n] = t, 1 === Object.keys(o).length && setTimeout(function() {
                    var e = o;
                    o = {}, Object.keys(e).forEach(function(t) {
                        var n = e[t];
                        n.exception ? r(n.exception) : n.error && r(n.error), console.log("WARNING: Promise with no error callback:" + n.id), console.log(n), n.exception && console.log(n.exception.stack)
                    })
                }, 0))
            });
            var s = function() {
            ...
            t.ErrorHandler = s, t.errorHandler = new s, t.setUnexpectedErrorHandler = function(e) {
                    t.errorHandler.setUnexpectedErrorHandler(e)
                }, t.onUnexpectedError = r, t.onUnexpectedExternalError = function(e) {
            ...
            var u = "Canceled";
            t.isPromiseCanceledError = i, t.canceled = function() {
                var e = new Error(u);
        ...
        r(e[9], t([1, 0, 10, 3, 12, 4, 18]), function(e, t, n, r, i, o, s) {
            ...
            var h = function() {
                ...
                return Object.defineProperty(e.prototype, "event", {
                    ...
                    this._listeners && (this._listeners = void 0),
                        this._deliveryQueue && (this._deliveryQueue.length = 0), this._disposed = !0
                }, e._noop = function() {}, e
            }();
            t.Emitter = h;
            var d = function() {
            ...
            t.EventMultiplexer = d, t.fromCallback = function(e) {
                var t, n = new h({
                    onFirstListenerAdd: function() {
            ...
            t.EventBufferer = p, t.mapEvent = a, t.forEach = l, t.filterEvent = c;
            var m = function() {
                function e(e) {
                    this._event = e
                }
            ...
            t.Relay = _, t.fromNodeEventEmitter = function(e, t, n) {
            ...
            function l(e, t) {
                ...
                }(e) ? new r.TPromise(function(r, i, o) {
                    e.done(function(e) {
                        try {
                            t(e)
                        } catch (e) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.isThenable = a, t.toThenable = function(e) {
                return a(e) ? e : r.TPromise.as(e)
            }, t.asWinJsPromise = function(e) {
                var t = new i.CancellationTokenSource;
                return new r.TPromise(function(n, i, o) {
                    var s = e(t.token);
                    s instanceof r.TPromise ? s.then(function(e) {
                        t.dispose(), n(e)
                    }, function(e) {
                        t.dispose(), i(e)
                    }, o) : a(s) ? s.then(function(e) {
                        t.dispose(), n(e)
                    }, function(e) {
                        t.dispose(), i(e)
                    }) : (t.dispose(), n(s))
                ...
                return i && (t = t.then(void 0, function(e) {
                    if (!n.isPromiseCanceledError(e)) return r.TPromise.wrapError(e)
                })), l(t, function() {
                    return o.dispose()
                })
            };
                ...
                return e.prototype.queue = function(e) {
                    ...
                    if (this.activePromise) {
                        if (this.queuedPromiseFactory = e, !this.queuedPromise) {
                            ...
                            this.queuedPromise = new r.TPromise(function(e, r, i) {
                                t.activePromise.then(n, n, i).done(e)
                            }, function() {
                                t.activePromise.cancel()
                            })
                        }
                        return new r.TPromise(function(e, n, r) {
                            t.queuedPromise.then(e, n, r)
                        }, function() {})
                    }
                    return this.activePromise = e(), new r.TPromise(function(e, n, r) {
            ...
            var d = function() {
                ...
                return e.prototype.trigger = function(e, t) {
                    var n = this;
                    return void 0 === t && (t = this.defaultDelay), this.task = e, this.cancelTimeout(), this.completionPromise || (this.completionPromise = new r.TPromise(function(e) {
                        n.onSuccess = e
            ...
            var m = function() {
                function e() {
                    var e = this;
                    this._isOpen = !1, this._promise = new r.TPromise(function(t, n, r) {
            ...
            }, t.always = l, t.sequence = c, t.first = function(e, t) {
                void 0 === t && (t = function(e) {
                    return !!e
                }), e = e.reverse().slice();
                var n = function() {
                    return 0 === e.length ? r.TPromise.as(null) : e.pop()().then(function(e) {
            ...
            t.ResourceQueue = y, t.setDisposableTimeout = function(e, t) {
            ...
            var S = function(e) {
                ...
                return o(t, e), t.prototype.throttle = function(e) {
                    var t = this;
            ...
            t.logOnceWebWorkerWarning = function(e) {
                u.isWeb && (l || (l = !0, console.warn("Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes. Please see https://github.com/Microsoft/monaco-editor#faq")), console.warn(e.message))
            };
            var c = function() {
                    function e(e) {
                        this._workerId = -1, this._handler = e,
                            this._lastSentReq = 0, this._pendingReplies = Object.create(null)
                    }
                    return e.prototype.setWorkerId = function(e) {
                        ...
                        if (e.seq) {
                            ...
                            if (delete this._pendingReplies[r.seq], r.err) {
                                var o = r.err;
                                return r.err.$isError && ((o = new Error).name = r.err.name, o.message = r.err.message, o.stack = r.err.stack), void i.e(o)
                            }
                            i.c(r.res)
                        } else {
                            var s = e,
                ...
                f = function(e) {
                    function t(t, n) {
                        ...
                        var u = null;
                        void 0 !== self.require && "function" == typeof self.require.getConfig ? u = self.require.getConfig() : void 0 !== self.requirejs && (u = self.requirejs.s.contexts._.config), r._lazyProxy = new i.TPromise(function(e, t, n) {
                            o = e, s = t
                        }, function() {}), r._onModuleLoaded = r._protocol.sendMessage(a, [r._worker.getId(), n, u]), r._onModuleLoaded.then(function(e) {
            ...
            var h = function() {
                function e(e, t) {
                    var n = this;
                    this._requestHandler = t, this._protocol = new c({
                ...
                return e.prototype.onmessage = function(e) {
                    ...
                    if (this._protocol.setWorkerId(e), this._requestHandler) {
                        var o = [];
                        for (var s in this._requestHandler) "function" == typeof this._requestHandler[s] && o.push(s);
                    ...
                    return self.require([t], function() {
                        ...
                        var i = [];
                        for (var o in r._requestHandler) "function" == typeof r._requestHandler[o] && i.push(o);
                        u(i)
                    }, a), l
                }, e
            }();
            t.SimpleWorkerServer = h, t.create = function(e) {
                return new h(e, null)
            }
        }),
        ...
        r(e[24], t([1, 0, 13, 16]), function(e, t, n, r) {
            ...
            var s = 5e3,
                ...
                l = function(e) {
                    ...
                    return o(t, e), t._getFirstNonBlankColumn = function(e, t) {
                        ...
                        for (var n = [], r = [], i = e; i <= t; i++)
                            for (var o = this.startMarkers[i], s = this.endMarkers[i], u = o.offset; u < s.offset; u++) n.push({
                                offset: u,
                ...
                c = function() {
                    ...
                    return e.createFromDiffChange = function(t, n, r) {
                        var i, o, s, u, a, l, c, f;
                        return 0 === t.originalLength ? (i = 0,
                            o = 0, s = 0, u = 0) : (i = n.getStartLineNumber(t.originalStart), o = n.getStartColumn(t.originalStart), s = n.getEndLineNumber(t.originalStart + t.originalLength - 1), u = n.getEndColumn(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (a = 0, l = 0, c = 0, f = 0) : (a = r.getStartLineNumber(t.modifiedStart), l = r.getStartColumn(t.modifiedStart), c = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1), f = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1)), new e(i, o, s, u, a, l, c, f)
                    }, e
                }(),
                f = function() {
                    function e(e, t, n, r, i) {
                    ...
                    return e.createFromDiffResult = function(t, n, r, o, s) {
                        var a, l, f, h, d;
                        if (0 === t.originalLength ? (a = n.getStartLineNumber(t.originalStart) - 1, l = 0) : (a = n.getStartLineNumber(t.originalStart), l = n.getEndLineNumber(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (f = r.getStartLineNumber(t.modifiedStart) - 1, h = 0) : (f = r.getStartLineNumber(t.modifiedStart),
                                h = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1)), 0 !== t.originalLength && 0 !== t.modifiedLength && o()) {
                            ...
                            s && (_ = function(e) {
                                ...
                                for (var t = [e[0]], n = t[0], r = 1, i = e.length; r < i; r++) {
                                    ...
                                    Math.min(s, a) < u ? (n.originalLength = o.originalStart + o.originalLength - n.originalStart, n.modifiedLength = o.modifiedStart + o.modifiedLength - n.modifiedStart) : (t.push(o), n = o)
                                }
                                return t
                            }(_)), d = [];
                            for (var g = 0, v = _.length; g < v; g++) d.push(c.createFromDiffChange(_[g], p, m))
                        }
                ...
                h = function() {
                    function e(e, t, n) {
                        this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.maximumRunTimeMs = s, this.originalLines = e,
                            this.modifiedLines = t, this.original = new l(e), this.modified = new l(t)
                    }
                    return e.prototype.computeDiff = function() {
                        if (1 === this.original.getLength() && 0 === this.original.getElementHash(0).length) return [{
                        ...
                        if (1 === this.modified.getLength() && 0 === this.modified.getElementHash(0).length) return [{
                            originalStartLineNumber: 1,
                        ...
                        var e = i(this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldMakePrettyDiff);
                        if (this.shouldIgnoreTrimWhitespace) {
                            for (var t = [], n = 0, r = e.length; n < r; n++) t.push(f.createFromDiffResult(e[n], this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldPostProcessCharChanges));
                            return t
                        }
                        for (var o = [], s = 0, u = 0, n = -1, a = e.length; n < a; n++) {
                            for (var c = n + 1 < a ? e[n + 1] : null, h = c ? c.originalStart : this.originalLines.length, d = c ? c.modifiedStart : this.modifiedLines.length; s < h && u < d;) {
                                var p = this.originalLines[s],
                                    m = this.modifiedLines[u];
                                if (p !== m) {
                                    for (var _ = l._getFirstNonBlankColumn(p, 1), g = l._getFirstNonBlankColumn(m, 1); _ > 1 && g > 1;) {
                                        if ((E = p.charCodeAt(_ - 2)) !== (S = m.charCodeAt(g - 2))) break;
                                        _--, g--
                                    }(_ > 1 || g > 1) && this._pushTrimWhitespaceCharChange(o, s + 1, 1, _, u + 1, 1, g);
                                    for (var v = l._getLastNonBlankColumn(p, 1), y = l._getLastNonBlankColumn(m, 1), b = p.length + 1, C = m.length + 1; v < b && y < C;) {
                                        var E = p.charCodeAt(v - 1),
                                            S = p.charCodeAt(y - 1);
                                        if (E !== S) break;
                                        v++, y++
                                    }
                                    (v < b || y < C) && this._pushTrimWhitespaceCharChange(o, s + 1, v, b, u + 1, y, C)
                                }
                                s++, u++
                            }
                            c && (o.push(f.createFromDiffResult(c, this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldPostProcessCharChanges)), s += c.originalLength, u += c.modifiedLength)
                        }
                        return o
                    }, e.prototype._pushTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
                        this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) || e.push(new f(t, t, i, i, [new c(t, n, t, r, i, o, i, s)]))
                    }, e.prototype._mergeTrimWhitespaceCharChange = function(e, t, n, r, i, o, s) {
                        var u = e.length;
                        if (0 === u) return !1;
                        var a = e[u - 1];
                        return 0 !== a.originalEndLineNumber && 0 !== a.modifiedEndLineNumber && (a.originalEndLineNumber + 1 === t && a.modifiedEndLineNumber + 1 === i && (a.originalEndLineNumber = t, a.modifiedEndLineNumber = i, a.charChanges.push(new c(t, n, t, r, i, o, i, s)), !0))
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var o = i[0].indexOf(" ") >= 0 ? function(e, t, n, r) {
                    ...
                    for (var u; u = t.exec(n);)
                        if (u.index <= i && t.lastIndex >= i) return {
                            word: u[0],
                ...
                l = function() {
                    ...
                    return e._createLink = function(e, t, n, r, i) {
                        ...
                        for (var r = (null === u && (u = new s([
                                ...
                                if (null === a) {
                                    for (a = new n.CharacterClassifier(0), e = 0; e < " \t<>'\"、。｡､，．：；？！＠＃＄％＆＊‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…".length; e++) a.set(" \t<>'\"、。｡､，．：；？！＠＃＄％＆＊‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…".charCodeAt(e), 1);
                                    for (var e = 0; e < ".,;".length; e++) a.set(".,;".charCodeAt(e), 2)
                                }
                                return a
                            }(), o = [], l = 1, c = t.getLineCount(); l <= c; l++) {
                            for (var f = t.getLineContent(l), h = f.length, d = 0, p = 0, m = 0, _ = 1, g = !1, v = !1, y = !1; d < h;) {
                                var b = !1,
                                    C = f.charCodeAt(d);
                                if (13 === _) {
                                    E = void 0;
            ...
            t.computeLinks = function(e) {
                return e && "function" == typeof e.getLineCount && "function" == typeof e.getLineContent ? l.computeLinks(e) : []
            }
            ...
            var n = function() {
                ...
                return e.prototype.navigateValueSet = function(e, t, n, r, i) {
                    if (e && t) {
                        if (o = this.doNavigateValueSet(t, i)) return {
                            range: e,
                            value: o
                        }
                    }
        ...
        }), r(e[28], t([1, 0, 9, 19, 2, 7, 20, 3, 11, 21, 6]), function(e, t, n, r, i, o, s, u, a, l, c) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            ...
            var p;
            ! function(e) {
                e[e.Unknown = 0] = "Unknown", e[e.Backspace = 1] = "Backspace", e[e.Tab = 2] = "Tab", e[e.Enter = 3] = "Enter", e[e.Shift = 4] = "Shift", e[e.Ctrl = 5] = "Ctrl", e[e.Alt = 6] = "Alt", e[e.PauseBreak = 7] = "PauseBreak", e[e.CapsLock = 8] = "CapsLock", e[e.Escape = 9] = "Escape", e[e.Space = 10] = "Space", e[e.PageUp = 11] = "PageUp", e[e.PageDown = 12] = "PageDown",
            ...
            }(p = t.KeyCode || (t.KeyCode = {})), t.createMonacoBaseAPI = function() {
                return {
                    editor: void 0,
                    languages: void 0,
            ...
            t.MirrorTextModel = i
        }), r(e[31], t([1, 0, 6, 3, 7, 24, 13, 2, 17, 26, 27, 25, 28, 5]), function(e, t, n, r, i, s, u, a, l, c, f, h, d, p) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            var m = function(e) {
                    ...
                    return o(t, e), Object.defineProperty(t.prototype, "uri", {
                        ...
                        Object.defineProperty(t.prototype, "version", {
                            ...
                            var t, n = this,
                                ...
                                s = [],
                                u = function() {
                                    if (o < s.length) r.done = !1, r.value = t.substring(s[o].start, s[o].end), o += 1;
                                    else {
                                        if (!(i >= n._lines.length)) return t = n._lines[i], s = n._wordenize(t, e), o = 0, i += 1, u();
                            ...
                            e = Math.floor(e),
                                e = Math.max(0, e), this._ensureLineStarts();
                ...
                _ = function() {
                    function t(e) {
                        this._foreignModuleFactory = e,
                            this._foreignModule = null
                    }
                    return t.prototype.computeDiff = function(e, t, n) {
                            ...
                            for (var s, a = [], l = 0, c = n; l < c.length; l++) {
                                ...
                                if ("number" == typeof p && (s = p), h) {
                                    ...
                                    if (d = d.replace(/\r\n|\n|\r/g, o.eol), m !== d)
                                        if (Math.max(d.length, m.length) > t._diffLimit) a.push({
                                            range: h,
                                            text: d
                                        });
                                        else
                                            for (var _ = u.stringDiff(m, d, !1), g = o.offsetAt(i.Range.lift(h).getStartPosition()), v = 0, y = _; v < y.length; v++) {
                                                var b = y[v],
                                                    C = o.positionAt(g + b.originalStart),
                                                    E = o.positionAt(g + b.originalStart + b.originalLength),
                                                    S = {
                            ...
                            if (s) {
                                ...
                                c[l] = !0;
                                for (var f = s.createWordIterator(a), h = f.next(); !h.done && u.length <= t._suggestionsLimit; h = f.next()) {
                                    var d = h.value;
                                    c[d] || (c[d] = !0, isNaN(Number(d)) && u.push({
                                        type: "text",
                                        label: d,
                                        insertText: d,
                                        noAutoAccept: !0,
                            ...
                            if (this._foreignModuleFactory) {
                                ...
                                var s = [];
                                for (var u in this._foreignModule) "function" == typeof this._foreignModule[u] && s.push(u);
                            ...
                            return new r.TPromise(function(r, s) {
                                e([t], function(e) {
                                    ...
                                    var t = [];
                                    for (var s in i._foreignModule) "function" == typeof i._foreignModule[s] && t.push(s);
                                    r(t)
                                }, s)
                            })
                        },
                        ...
                        }, t._diffLimit = 1e4, t._suggestionsLimit = 1e4, t
                }();
            ...
            var g = function(e) {
                ...
                return o(t, e), t.prototype.dispose = function() {
                    ...
                    this._models[e.url] = new m(n.default.parse(e.url), e.lines, e.EOL, e.versionId)
            ...
            t.EditorSimpleWorkerImpl = g, t.create = function() {
                return new g(null)
            }, "function" == typeof importScripts && (p.globals.monaco = d.createMonacoBaseAPI())
        }),
        function() {
            "use strict";
                    ...
                    require([e], function(e) {
                        setTimeout(function() {
                            ...
                            for (self.onmessage = function(e) {
                                ...
                                }; r.length > 0;) self.onmessage(r.shift())
                        }, 0)
                    })
                }(e.data)) : r.push(e)
            }
